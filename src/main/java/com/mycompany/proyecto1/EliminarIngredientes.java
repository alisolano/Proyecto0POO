 ...
 * @author JP113
 */
public class EliminarIngredientes extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ingrese el codigo del ingrediente que desea eliminar");
    ...
    private void EliminarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EliminarBtnActionPerformed
        ...
        if (!recetario.existeIngrediente(codigo)) {
            JOptionPane.showMessageDialog(this, "Ingrediente no encontrado", "Error", JOptionPane.ERROR_MESSAGE);
        } else {
            recetario.eliminarIngrediente(codigo);
            SuccessBox("Ingrediente eliminado con éxito", "");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EliminarIngredientes dialog = new EliminarIngredientes(new javax.swing.JFrame(), true);
